...
qq.extend(qq.UploadHandlerForm.prototype, {
    ...
    _upload: function (id, params) {
        ...
        self._options.AraReponse = function (response) {
            ...
            setTimeout(function () {
                if (self._detach_load_events[id]) {
...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    */
    ...
    _onComplete: function (id, xhr) {
        ...
        if (xhr.status !== 200) {
            _Self._options.onError(id, name, "XHR returned response code " + xhr.status);
        }

        _Self._options.AraReponse = function (response) {   
            _Self._options.onComplete(id, name, response);
        ...
        //eval(xhr.responseText.substring(41, xhr.responseText.length - 17));
    },
    _cancel: function (id) {
        this._options.onCancel(id, this.getName(id));
